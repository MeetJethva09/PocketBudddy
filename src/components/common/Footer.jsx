...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-indigo-900 to-purple-900 text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-indigo-100">
              Your ultimate companion for discovering the best food deals and restaurant offers.
            </p>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3">
              <input
                ...
                className="px-4 py-2 rounded-lg bg-indigo-800 bg-opacity-50 border border-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-indigo-300 text-white outline-none"
                required
              />
              <button
                type="submit"
